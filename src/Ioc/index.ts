...
import { IocContract, BindCallback, FakeCallback, LookupNode, InferMakeType, Exception } from "../../types/index.ts";
import { emitWarning } from "../emitWarning_deno.ts";

import { Fakes } from './Fakes.ts'
import { Bindings } from './Bindings.ts'
import { Injector } from './Injector.ts'
import { IocResolver } from '../Resolver.ts'
import { ImportAliases } from './ImportAliases.ts'
import { ensureIsFunction, isEsm } from '../Helpers.ts'
import { IocProxyClass, IocProxyObject } from './IocProxy.ts'
import { IocLookupException } from '../Exceptions.ts'
...
export class Ioc implements IocContract {
   ...
   */
  private trapCallback: ((namespace: string) => any) | undefined

  /**
   * Define the module type for resolving auto import aliases. Defaults
   * to `cjs`
   */
  public module: 'esm' = 'esm';
   ...
   * work
   */
  public useProxies(enable = true): this {
  ...
  public bind(binding: string, callback: BindCallback<any, this>): this {
    ...
    this.bindings.register(binding, callback as BindCallback<any, IocContract<any>>, false)
    return this
  }
  ...
  public singleton(binding: string, callback: BindCallback<any, this>): this {
    ...
    this.bindings.register(binding, callback as BindCallback<any, IocContract<any>>, true)
    return this
  }
  ...
  public fake(namespace: string, callback: FakeCallback<any, this>): this {
    ...
    this.fakes.register(namespace, callback as BindCallback<any, IocContract<any>>)
    return this
  }
   ...
   * - prefixNamespace: CMS/Controllers/Http
   * - Output: CMS/Controllers/Http/UsersController
   *
   * Prefix namespace is ignored for absolute namespaces. For example:
   *
   * - namespace: /CMS/UsersController
   * - prefixNamespace: CMS/Controllers/Http
   * - Output: CMS/UsersController
   */
